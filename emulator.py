...
def down_button(server_id):
    return movement(
        WindowEvent.PRESS_ARROW_DOWN, WindowEvent.RELEASE_ARROW_DOWN, server_id
    )


def left_button(server_id):
    return movement(
        WindowEvent.PRESS_ARROW_LEFT, WindowEvent.RELEASE_ARROW_LEFT, server_id
    )


def right_button(server_id):
    return movement(
        WindowEvent.PRESS_ARROW_RIGHT, WindowEvent.RELEASE_ARROW_RIGHT, server_id
    )


def start_button(server_id):
    return movement(
        WindowEvent.PRESS_BUTTON_START, WindowEvent.RELEASE_BUTTON_START, server_id
    )


def select_button(server_id):
    return movement(
        WindowEvent.PRESS_BUTTON_SELECT, WindowEvent.RELEASE_BUTTON_SELECT, server_id
    )
